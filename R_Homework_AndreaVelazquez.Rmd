...
age<- 20
birthday<- "04/18/2003"
three_fav_colors<- c("pink", "black", "blue")

#Name is a string, age is an int, brithday is a string, and three_fav_colors is a vector of strings
```
...
product_sum<- sum(list_of_numbers)
min_list<- min(list_of_numbers)
mean_list<- mean(list_of_numbers)
mode_list<- mode(list_of_numbers)
